...
namespace rt
{
	...
	public:
		...
		**/
		...
		/// Returns true if pt is inside object
		virtual bool inside(Vector3d &pt)const = 0;

		/// Prints information about the object to stream.
		virtual void print(std::ostream &stream) const = 0;
		
		/// Get u-texture coordinate of object
		virtual double get_tex_u(Eigen::Vector3d &pt) const = 0;

		/// Get v-texture coordinate of object
		virtual double get_tex_v(Eigen::Vector3d &pt) const = 0;
